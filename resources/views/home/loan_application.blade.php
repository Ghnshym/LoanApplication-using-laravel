...
<div class="container">
    ...
    <form method="POST" action="{{ route('loan_store') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control @error('loan_amount') is-invalid @enderror" id="loan_amount" name="loan_amount" value="{{ old('loan_amount') }}" required>
            @error('loan_amount')
                <span class="invalid-feedback" role="alert">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('loan_purpose') is-invalid @enderror" id="loan_purpose" name="loan_purpose" rows="3" required>{{ old('loan_purpose') }}</textarea>
            @error('loan_purpose')
                <span class="invalid-feedback" role="alert">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div id="employedFields" class="d-none">
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('employer_name') is-invalid @enderror" id="employer_name" name="employer_name" value="{{ old('employer_name') }}">
                @error('employer_name')
                    <span class="invalid-feedback" role="alert">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" class="form-control @error('monthly_income') is-invalid @enderror" id="monthly_income" name="monthly_income" value="{{ old('monthly_income') }}">
        ...
        <div id="selfEmployedFields" class="d-none">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" class="form-control @error('business_monthly_income') is-invalid @enderror" id="business_monthly_income" name="business_monthly_income" value="{{ old('business_monthly_income') }}">
